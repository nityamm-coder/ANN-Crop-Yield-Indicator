...
def predict_api():
    ...
    try:
        ...
        # Get ANN prediction and confidence
        ...
        # Use ANN prediction if confident, otherwise use rule-based
...
if __name__ == "__main__":
    ...
    print("✅ CORS enabled for React/JavaScript frontend")
    print("="*70)
    print("\nAPI Endpoints:")
    print("  • GET  /api/crops    - Get list of crops")
    print("  • POST /api/predict  - Get yield prediction")
